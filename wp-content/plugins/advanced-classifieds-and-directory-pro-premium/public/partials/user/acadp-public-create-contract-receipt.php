    ...
    <div class="row d-flex justify-content-center">
    	<div class="col-md-6">
               ...
               <tr>
                ...
                <a class="btn btn-default" href="https://explorer.testnet.aurora.dev/tx/<?php echo $contract_tx_hash; ?>"><?php esc_html_e( 'View on Block Explorer', 'advanced-classifieds-and-directory-pro' ); ?></a>
		</div>
    </div>
</div>