	...
	<div class="row">    	
        ...
        <div class="<?php echo $has_sidebar ? 'col-md-8' : 'col-md-12'; ?>">  
            ...
            <div class="pull-left">
                ...
                $meta[] = sprintf( '<span class="glyphicon glyphicon-file"></span>&nbsp;<a href="https://ipfs.io/ipfs/%s/metadata.json">%s</a>', $post_meta['ipfs_metadata_cid'][0], esc_html__( 'View on IPFS', 'advanced-classifieds-and-directory-pro' ) );
