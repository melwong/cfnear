...
<div class="acadp acadp-user acadp-payment-receipt">
    ...
    <div class="row">
    	<div class="col-md-6">
			...
			<a class="btn btn-default" href="https://explorer.testnet.aurora.dev/tx/<?php echo esc_html( $post_meta['transaction_id'][0] ); ?>"><?php esc_html_e( 'View on Block Explorer', 'advanced-classifieds-and-directory-pro' ); ?></a>
		</div>
