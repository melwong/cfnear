...
<div class="acadp acadp-user acadp-checkout">
    ...
    <form id="acadp-checkout-form" class="form-vertical" method="post" action="" role="form">
		<table id="acadp-checkout-form-data" class="table table-stripped table-bordered">
			...
			<tr>
				<td><?php esc_html_e( 'File URL :', 'advanced-classifieds-and-directory-pro' ); ?> <a href="<?php echo esc_attr( $token_uri ); ?>"><?php esc_html_e( 'View File', 'advanced-classifieds-and-directory-pro' ); ?></a>
				</td>
			</tr>
    	</table>
		...
		<input type="hidden" name="payment_gateway" value="NEAR" />
