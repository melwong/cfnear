...
(function ($) {
  ...
  $(function () {
    ...
    $("#acadp-upload-image-hidden").change(function () {
      ...
      //Mel: 29/01/22. Display loading spinner
      $("#acadp-progress-image-upload")
        .addClass("uploading")
        .html('<div class="acadp-spinner"></div>');

      //Mel: 24/01/22. Start. Upload image to IPFS via nft.storage
    ...
    if ($.fn.validator) {
      ...
      $("#acadp-post-form")
        ...
        .on("submit", function (e) {
          ...
          //Mel: 26/01/22
          // Save a metadata json file of the post and then upload it to IPFS
          e.preventDefault();

          //Mel: 29/01/22. Spins the spinner and disable submit btn
